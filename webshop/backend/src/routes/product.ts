...
import { Product } from "../types/database-types.js";
import { matchedData, param } from "express-validator";
import { StatusCodes } from "http-status-codes";
import RequestError from "../util/RequestError.js";
import processValidation from "../util/validation.js";
import { ProductPreview } from "../types/data-transfer-objects.js";
...
export const optionalAndBoilerplateAttrs = ["details", "description", "imageUrls", "characteristics", "sizes"] as const;
...
export function addProduct(product: Omit<Product, OptionalAndBoilerplateProductAttrs> & Partial<Pick<Product, OptionalAndBoilerplateProductAttrs>>): number {
  ...
  products[id] = { sizes: [], details: "", description: "", characteristics: [], imageUrls: [], ...product };
